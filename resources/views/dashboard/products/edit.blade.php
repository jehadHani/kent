            ...
            <div id="kt_toolbar_container" class="container-fluid d-flex flex-stack">
                ...
                <div data-kt-place="true" data-kt-place-mode="prepend" data-kt-place-parent="{default: '#kt_content_container', 'lg': '#kt_toolbar_container'}" class="page-title d-flex flex-column align-items-start me-3">
                    ...
                    <ul class="breadcrumb breadcrumb-separatorless fw-bold fs-7 my-1">
                        ...
                        <!--end::Item-->
                        <!--begin::Item-->
                        <li class="breadcrumb-item text-dark">تعديل المنتج</li>
                        <!--end::Item-->
                    </ul>
                    <!--end::Breadcrumb-->
                </div>
                    ...
                    <!--end::Alert-->
                        ...
                        <div class="modal-body col-md-12 scroll-y px-10 px-lg-15 pt-0 pb-15">
                            ...
                            <div class="mb-13 text-center">
                                <!--begin::Title-->
                                <h1 class="mb-3">التعديل على بيانات المنتج</h1>
                                <!--end::Title-->
                                <!--begin::Description-->
                                    ...
                                    <div class="col-md-3 mb-10" style="border:1px ">
                                        ...
                                        <div class="image-input image-input-outline" data-kt-image-input="true"
                                            ...
                                            <div class="image-input-wrapper w-225px h-225px"
                                                 style="background-image: url({{asset('product-images/'.$product->image)}})"></div>
                                        ...
                                        <div class="row">
                                            <div class="col-md-12 d-flex flex-column mb-8 fv-row">
                                                ...
                                                <input type="text" class="form-control form-control-solid"
                                                       placeholder="عنوان المنتج" name="name" value="{{$product->name}}"/>
                                                @error('name')
                                                <span class="text-danger">
                                                            {{$message}}
                                                        </span>
                                            ...
                                            <div class="col-md-6 d-flex flex-column mb-8 fv-row">
                                                ...
                                                <input type="number" class="form-control form-control-solid"
                                                       placeholder="سعر المنتج" name="price" value="{{$product->price}}"/>
                                                @error('price')
                                                <span class="text-danger">
                                                            {{$message}}
                                                        </span>
                                            ...
                                            <div class="col-md-12 d-flex flex-column mb-8 fv-row">
                                                ...
                                                <textarea style="min-height: 100px" class="form-control form-control-solid"
                                                          placeholder="وصف المنتج" name="description">{{$product->description}}</textarea>
                                                @error('description')
                                                <span class="text-danger">
                                                            {{$message}}
                                                        </span>
