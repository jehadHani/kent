            ...
            <div id="kt_toolbar_container" class="container-fluid d-flex flex-stack">
                ...
                <div data-kt-place="true" data-kt-place-mode="prepend" data-kt-place-parent="{default: '#kt_content_container', 'lg': '#kt_toolbar_container'}" class="page-title d-flex flex-column align-items-start me-3">
                    ...
                    <ul class="breadcrumb breadcrumb-separatorless fw-bold fs-7 my-1">
                        ...
                        <!--end::Item-->
                        <!--begin::Item-->
                        <li class="breadcrumb-item text-dark">المنتجات</li>
                        <!--end::Item-->
                    </ul>
                    <!--end::Breadcrumb-->
                </div>
                ...
                <!--begin::Alert-->
                    <div id="update" class="alert alert-primary d-flex align-items-center p-5 mb-10">
                        ...
                        <div class="d-flex flex-column pe-0 pe-sm-10">
                            ...
                            <!--end::Title-->
                            <!--begin::Content-->
                            <span>تم تعديل بيانات المنتج بنجاح</span>
                            <!--end::Content-->
                        </div>
                        <!--end::Wrapper-->
                        <!--begin::Close-->
                        ...
                        <div class="table-responsive">
                            ...
                            <table class="table align-middle gs-0 gy-4">
                                ...
                                <tr class="fw-bolder text-muted bg-light">
                                    <th class="ps-4 rounded-start">المنتج</th>
                                        ...
                                        <td>
                                            <div class="d-flex align-items-center">
                                                <div class="symbol symbol-70px me-5">
                                                    <img src="{{asset('product-images/'.$product->image)}}" class="" alt="">
                                                </div>
                                                <div class="d-flex justify-content-start flex-column">
                                                    <span  class="text-dark fw-bolder text-hover-primary mb-1 fs-6">{{Str::limit($product->name ,100)}}</span>
                                                </div>
                                            </div>
                                        </td>
                                        <td>
                                            <span class="badge badge-danger mb-1 fs-7">$ {{$product->price}}</span>
                                        </td>
                                        <td>
                                            <span class="badge badge-primary mb-1 fs-7">{{$product->category->name}}</span>
                                        </td>
                                        <td >
